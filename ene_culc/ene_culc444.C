...
int ene_culc(int run){
  ...
  TH1F *hist0 = new TH1F("name0","title",200,-1,1);
  TH1F *hist1 = new TH1F("name1","title",200,-1,1);
  TH1F *hist2 = new TH1F("name2","title",200,-1,1);
  TH1F *hist3 = new TH1F("name3","title",200,-1,1);

  TH1F *hist4 = new TH1F("name4","title",200,-1,1);
  TH1F *hist5 = new TH1F("name5","title",200,-1,1);
  TH1F *hist6 = new TH1F("name6","title",200,-1,1);
  TH1F *hist7 = new TH1F("name7","title",200,-1,1);

  TH1F *hist8 = new TH1F("name8","title",200,-1,1);
  TH1F *hist9 = new TH1F("name9","title",200,-1,1);
  TH1F *hist10 = new TH1F("name10","title",200,-1,1);
  TH1F *hist11 = new TH1F("name11","title",200,-1,1);

  TH1F *hist12 = new TH1F("name12","title",200,-1,1);
  TH1F *hist13 = new TH1F("name13","title",200,-1,1);
  TH1F *hist14 = new TH1F("name14","title",200,-1,1);
  TH1F *hist15 = new TH1F("name15","title",200,-1,1);
