void hist_Dron() {
  ...
  TFile *file3 = TFile::Open("../rootfile/Dronb_all.root");
    ...
    //    fiqtFunc->SetParLimits(1, 0.2326, 0.2326);    // Scale_hb
    //2
    ...
    //
    fitFunc->SetParameters(tmp_13C, tmp_b, 1000, 7.6, 0.1, 100, 9, 1);
    fitFunc->SetParLimits(0, tmp_13C, tmp_13C);  // Scale_h13C
    fitFunc->SetParLimits(1, tmp_b, tmp_b);    // Scale_hb
    ...
    fitFunc->SetParLimits(6, 9.5, 10.5);    // Gauss2_Mean
    fitFunc->SetParLimits(7, 0.1, 1.0);   // Gauss2_Sigma
