...
{                                                                                                                                                         
  ...
  for(Int_t i=0;i<ch;i++){
    ...
    for(Int_t j=0;j<peak_n;j++){                                                                                               cout << peak[j] << endl;
